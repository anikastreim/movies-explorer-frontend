            ...
            <form className='profile__form'>
              ...
              <label className='profile__label'>
                ...
                {isEdit
                  ...
                  :
                  <>
                    <button className='profile__edit' onClick={handleEdit} type='submit'>Редактировать</button>
                    <Link to='/'><button className='profile__signout' type='button'>Выйти из аккаунта</button></Link>
                  </>
                }
              </div>
            </form>
