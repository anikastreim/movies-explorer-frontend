...
function Navigation() {
  ...
  return (
    <div className='navigation'>
      <button className='navigation__burger' onClick={handleOpenMenu}>
        {isMenuOpened ?
          <img className='navigation__close' src={close} alt='крестик' />
        :  
          <img className='navigation__menu' src={burger} alt='бургер-меню' />
        }
      </button>
